...
문제에서 요구한 것은 매번 달라지는 n에 대해서 재귀함수를 실행시킨다고 할 때 fibonacci(0)과 fibonacci(1)이 몇 번 불리는지 구하는 것이었다. 즉, 문제에서 직접 정의해준 fibonacci 함수의 printf문을 통한 "출력"을 의미한다.  
...
N에 따라 달라지는 0과 1의 출력횟수는 위의 표와 같다.  
